...
public class TestGUI : MonoBehaviour { private BaseCharacterClass class1 = new baseMage{};
private BaseCharacterClass class2 = new baseWarrior{}; public TextMesh text;
